...
export function Meal(){
    ...
    return <div>
        <input className="textbox" type="text" placeholder="Enter the name of food items"onChange={(e)=>setName(e.target.value)}/>
        <button className="searchbtn" onClick={()=>handleSearch(name)}>Search</button>
        {data.map(e=>(<div id="box_layout">
            <img className="imglayout" src={e.strMealThumb} alt="fooditemimage"/>
